...
variable "iso_checksum" {
  type    = string
  default = "82441c7c9630b313d4183106231b08e192382bb6c7827e62acd467a749f030b9"
}

variable "iso_url" {
  type    = string
  default = "https://download.rockylinux.org/pub/rocky/9.3/isos/x86_64/Rocky-9.3-x86_64-dvd.iso"
}
